...
router.post('/', adminAuth, async (req, res) => {
  try {
    const { title, title_sw, subject, description, description_sw, thumbnail, html_code, is_premium, scoring_config } = req.body;
...
router.put('/:id', adminAuth, async (req, res) => {
  try {
    const { title, title_sw, subject, description, description_sw, thumbnail, is_premium, is_published } = req.body;
    ...
    const result = await query(
      ...
      [title, title_sw, subject, description, description_sw, thumbnail, is_premium, is_published, req.params.id]
    );
