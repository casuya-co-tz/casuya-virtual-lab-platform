...
export default function EditLabPage() {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="text-[clamp(20px,4vw,28px)] font-bold text-text-primary mb-6">{t('admin.editLab', lang)}</h1>
      <Card>
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <select className="w-full border border-border-DEFAULT bg-bg-primary text-text-primary p-3 text-[14px]" value={form.subtopic_id} onChange={e => setForm({ ...form, subtopic_id: e.target.value })}>
          ...
          <div className="flex gap-3">
            <Button variant="primary" type="submit">{t('admin.saveChanges', lang)}</Button>
