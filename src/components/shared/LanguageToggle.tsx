...
export function LanguageToggle({ lang, onToggle }: LanguageToggleProps) {
  return (
    <button
      onClick={onToggle}
      className="flex items-center h-9 bg-bg-secondary border border-border rounded-xl overflow-hidden text-[12px] font-bold uppercase tracking-[0.5px] transition-shadow hover:shadow-sm"
    >
